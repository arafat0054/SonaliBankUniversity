    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateStoredProcedure(
                ...
                body:
                    @"INSERT [dbo].[Department]([Name], [Budget], [StartDate], [TeacherID])
                      VALUES (@Name, @Budget, @StartDate, @TeacherID)
            ...
            CreateStoredProcedure(
                ...
                body:
                    @"UPDATE [dbo].[Department]
                      SET [Name] = @Name, [Budget] = @Budget, [StartDate] = @StartDate, [TeacherID] = @TeacherID
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CourseTeacher", "TeacherID", "dbo.Person");
            ...
            DropForeignKey("dbo.Department", "TeacherID", "dbo.Person");
            DropForeignKey("dbo.TeacherOffice", "TeacherID", "dbo.Person");
